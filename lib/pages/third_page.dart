    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.poppins(
                    color: const Color.fromRGBO(216, 221, 235, 1),
                    fontSize: 21,
          ...
          const SizedBox(height: 50), // space between the text and animation
          ...
          const SizedBox(
              height: 45), // space between the animation and next text
